...
// (ή και ο ίδιος φυσικά).
public class OpenGroup extends Group{
    
//  Η κλάση δεν έχει δικές της ιδιότητες έτσι στο κατασκευαστή χρησιμοποιούμε το
//  κατασκευαστή super() που κληρονομεί από τη parent κλάση Group 
...
//  μεθόδους addPost και addReplyPost
    private Boolean checkFriends(User usr){
        ...
        // H μέθοδος αφαιρεί απο το πίνακα που τη καλεί όλα τα μή κοινά στοιχεία που έχει με το πίνακα που βάζουμε ως
...
//  Η μέθοδος λαμβάνει ως ορίσματα το αρχικό Post και την απάντηση
