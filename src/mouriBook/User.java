...
public class User {
    ...
    // Ο κατασκευαστής αρχικοποιεί το όνομα και το email του χρήστη
...
//    }
    ...
    // Η μέθοδος δέχεται ως παράμετρο έναν άλλο χρήστη και επιστέφει true ή false
    ...
    // Η μέθοδος υλοποιεί την αμφίδρομη σχεση των φίλων. Δεν έχει έλεγχο για το αν είναι ήδη φίλοι
    // γιατί η κλήση της γίνεται στη μέθοδο addFriend() μέτα που έχει κάνει τον απαραίτητο ελέγχο.
